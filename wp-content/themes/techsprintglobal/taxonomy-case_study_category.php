<?php
/**
 * Template Name: Case Study Category Archive
 * Taxonomy template for Case Study Categories
 *
...
<main id="primary" class="site-main case-study-category-page">
		...
		<div class="container">
								...
								<article <?php post_class('blog-card'); ?>>
									...
									<div class="blog-content">
										...
										if ($categories && !is_wp_error($categories)) {
											...
											foreach ($categories as $category) {
												$category_link = get_term_link($category);
												echo '<a href="' . esc_url($category_link) . '" class="blog-category">' . esc_html($category->name) . '</a>';
											}
											echo '</div>';
										}
										?>
					...
					<?php else: ?>
						...
						<div class="no-posts">
							...
							<p>Please add some case studies to showcase your work.</p>
						</div>
